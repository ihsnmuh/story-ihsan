...
export default function Footer() {
  return (
    <footer className='py-5 px-10 md:px-36 bg-blue-500 dark:bg-gray-800 h-18 w-full justify-center md:flex lg:justify-between content-center items-center'>
      ...
      <div className='divide-white divide-x text-center'>
        <SocialMedia
          icon={
            <Mail className='fill-current text-white hover:text-blue-600 dark:hover:text-yellow-500' />
          }
          socialMedia='Email'
