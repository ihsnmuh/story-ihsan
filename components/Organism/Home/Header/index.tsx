import { Download, GitHub, Instagram, LinkedIn, Mail } from '@mui/icons-material';
      ...
      <div className='max-w-6xl space-y-10 lg:space-y-0 lg:space-x-10 flex flex-col-reverse lg:space-x-10 lg:flex lg:flex-row'>
        <div className='space-y-5 md:space-y-10 text-center lg:text-left md:flex md:flex-col md:justify-center lg:flex-1'>
          ...
          <motion.h1
            ...
            initial='before'
            animate='after'
            className='space-y-1 text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold text-blue-default-blue dark:text-yellow-400'
          >
            {
              <Typewriter
                options={{
          ...
          >
            I’m <span className='font-bold text-blue-default-blue dark:text-yellow-400'>Ihsan</span>, a{' '}
            <span className='font-bold text-blue-default-blue dark:text-yellow-400'>Frontend Developer</span>, hope to
            be <span className='font-bold text-blue-default-blue dark:text-yellow-400'>Fullstack Developer</span> and
            interest in <span className='font-bold text-blue-default-blue dark:text-yellow-400'>UI / UX Designer</span>,
          ...
          >
            <SocialMedia
              icon={
                <Mail className='fill-current text-blue-default-blue dark:text-white hover:text-blue-500 dark:hover:text-yellow-500' />
              }
              socialMedia='Email'
            ...
            <SocialMedia
              icon={
                <LinkedIn className='fill-current text-blue-default-blue dark:text-white hover:text-blue-500 dark:hover:text-yellow-500' />
              }
            ...
            <SocialMedia
              icon={
                <GitHub className='fill-current text-blue-default-blue dark:text-white hover:text-blue-500 dark:hover:text-yellow-500' />
              }
              socialMedia='GitHub'
            ...
            <SocialMedia
              icon={
                <Instagram className='fill-current text-blue-default-blue dark:text-white hover:text-blue-500 dark:hover:text-yellow-500' />
              }
        ...
        <motion.div variants={varianMotion(0.2)} initial='before' animate='after' className='relative lg:flex-1'>
          <div className='relative w-full h-full flex justify-center lg:justify-end content-center items-center mb-10 md:mb-10'>
            <div className='transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 relative shadow-lg h-64 w-64 lg:h-96 lg:w-96 rounded-full bg-transparent border-8 p-2 border-blue-default-blue dark:border-yellow-400 flex items-center justify-center'>
              <img
