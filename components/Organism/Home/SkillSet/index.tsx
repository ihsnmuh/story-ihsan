...
export default function SkillSetSection() {
  return (
    <div className='flex flex-col justify-center content-center text-center p-6 lg:px-40 lg:py-20 bg-blue-50 dark:bg-gray-600'>
      <Dotes />
      ...
      <div className='flex flex-col sm:grid sm:grid-cols-2 xl:grid-cols-3'>
        {CardStacks.map((CardStack, idx) => (
          <div key={idx} className='p-6'>
            <CardSkillSet category={CardStack.category} stacks={CardStack.stacks} />
          </div>
        ))}
      </div>
    </div>
